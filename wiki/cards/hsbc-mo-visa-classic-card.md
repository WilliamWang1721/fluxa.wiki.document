...
title: '汇丰澳门 Visa 经典卡'
shortName: 'Visa 经典卡'
slug: hsbc-mo-visa-classic-card
country: MO
bank: hsbc-macau
...
rebateCalculator:
  enabled: true
  calculatorId: globalHsbcMoVisaClassicCard
  issuer: 'HSBC MO'
...
> 澳门 HSBC 官方信用卡产品。官方名称：HSBC Visa Classic Card。状态：官方产品页列出，未见停售标记。
...
| 银联双币 | 否 |
| 计算器插件 | `globalHsbcMoVisaClassicCard` |
| 英文官方名 | HSBC Visa Classic Card |
| 产品状态 | 官方产品页列出，未见停售标记 |

## 概述

**汇丰澳门 Visa 经典卡** 是 [[banks:hsbc-macau|汇丰澳门]](../banks/hsbc-macau.md) 在澳门市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `globalHsbcMoVisaClassicCard` |
| 兑换计算器 | 否 | `—` |
