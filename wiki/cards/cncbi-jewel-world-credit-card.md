---
collection: cards
title: '信银香港 Jewel World 信用卡'
shortName: 'Jewel World'
slug: cncbi-jewel-world-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: cncbiJewelWorldCreditCard
...
sources:
  - 'citic-international-official-terms-24'
origin: payload-website-starter
generatedAt: 2026-08-21
---
{{Infobox card}}

# 信银香港 Jewel World 信用卡

> 信银香港 Jewel World 信用卡按生活类别、基本奖赏与 FTF 规则收录。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 信银香港 Jewel World 信用卡 |
| 简称 | Jewel World |
| 市场 | 香港 |
...
| 基本回赠 | 0.4% |
| 奖赏单位 | HKD |
| 计算器插件 | `cncbiJewelWorldCreditCard` |

## 概述

**信银香港 Jewel World 信用卡** 是 [[banks:citic-international|中信银行国际]](../banks/citic-international.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| --- | --- |
| 基本现金回赠 | 0.4% |
| PAYROLL plus 额外现金回赠未计入 | 未确认，不计入 |

## 计算器接入

| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `cncbiJewelWorldCreditCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:citic-international-official-terms-24|中信银行国际 官方产品 / 条款]](../sources/citic-international-official-terms-24.md) — https://www.cncbinternational.com/personal/promotions/jewelworld_credit_card/en/index.html
