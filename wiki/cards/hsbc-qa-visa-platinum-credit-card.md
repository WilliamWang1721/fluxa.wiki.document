---
collection: cards
title: '汇丰卡塔尔 Visa Platinum 信用卡'
shortName: 'Visa Platinum'
slug: hsbc-qa-visa-platinum-credit-card
country: QA
bank: hsbc-qatar
...
rebateCalculator:
  enabled: true
  calculatorId: globalHsbcQaVisaPlatinumCreditCard
  issuer: 'HSBC QA'
...
relatedCards:
  ...
  - 'hsbc-qa-advance-platinum-credit-card'
...
# 汇丰卡塔尔 Visa Platinum 信用卡

> 卡塔尔 HSBC 官方信用卡产品。官方名称：HSBC Visa Platinum Credit Card。状态：官方产品页列出，未见停售标记。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 汇丰卡塔尔 Visa Platinum 信用卡 |
| 简称 | Visa Platinum |
| 市场 | 卡塔尔 |
...
| 银联双币 | 否 |
| 计算器插件 | `globalHsbcQaVisaPlatinumCreditCard` |
| 英文官方名 | HSBC Visa Platinum Credit Card |
| 产品状态 | 官方产品页列出，未见停售标记 |

## 概述

**汇丰卡塔尔 Visa Platinum 信用卡** 是 [[banks:hsbc-qatar|汇丰卡塔尔]](../banks/hsbc-qatar.md) 在卡塔尔市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `globalHsbcQaVisaPlatinumCreditCard` |
| 兑换计算器 | 否 | `—` |
