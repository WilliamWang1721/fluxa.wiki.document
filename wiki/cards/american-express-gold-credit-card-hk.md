...
title: '美国运通金信用卡'
shortName: '金信用卡'
slug: american-express-gold-credit-card-hk
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: amexGoldCreditCard
...
> 美国运通金信用卡按餐饮 / 生活类别、基本奖赏与 FTF 规则收录。
...
| 基本回赠 | 1 MR / HK$1 |
| 奖赏单位 | MR Points |
| 计算器插件 | `amexGoldCreditCard` |

## 概述

**美国运通金信用卡** 是 [[banks:american-express|美国运通]](../banks/american-express.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
