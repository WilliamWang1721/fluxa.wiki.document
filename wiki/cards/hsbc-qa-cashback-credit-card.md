---
collection: cards
title: '汇丰卡塔尔 Cashback 信用卡'
shortName: 'Cashback'
slug: hsbc-qa-cashback-credit-card
country: QA
bank: hsbc-qatar
...
rebateCalculator:
  enabled: true
  calculatorId: globalHsbcQaCashbackCreditCard
  issuer: 'HSBC QA'
...
> 卡塔尔 HSBC 官方信用卡产品。官方名称：HSBC Cashback Credit Card。状态：官方产品页列出，未见停售标记。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 汇丰卡塔尔 Cashback 信用卡 |
| 简称 | Cashback |
| 市场 | 卡塔尔 |
...
| 银联双币 | 否 |
| 计算器插件 | `globalHsbcQaCashbackCreditCard` |
| 英文官方名 | HSBC Cashback Credit Card |
| 产品状态 | 官方产品页列出，未见停售标记 |

## 概述

**汇丰卡塔尔 Cashback 信用卡** 是 [[banks:hsbc-qatar|汇丰卡塔尔]](../banks/hsbc-qatar.md) 在卡塔尔市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `globalHsbcQaCashbackCreditCard` |
| 兑换计算器 | 否 | `—` |
