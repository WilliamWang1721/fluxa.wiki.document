---
collection: cards
title: '东亚银行 BEA GOAL 信用卡'
shortName: 'BEA GOAL'
slug: bea-goal-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: beaGoalCreditCard
...
> 东亚银行 BEA GOAL 信用卡按现金回赠 / 基本奖赏与 FTF 规则收录。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 东亚银行 BEA GOAL 信用卡 |
| 简称 | BEA GOAL |
| 市场 | 香港 |
...
| 基本回赠 | 0.4% |
| 奖赏单位 | HKD |
| 计算器插件 | `beaGoalCreditCard` |

## 概述

**东亚银行 BEA GOAL 信用卡** 是 [[banks:bank-of-east-asia|东亚银行]](../banks/bank-of-east-asia.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
