...
title: '东亚银行银联双币白金信用卡'
shortName: '银联双币白金'
slug: bea-unionpay-dual-currency-platinum-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: beaUnionPayDualCurrencyPlatinum
...
> 东亚银行银联双币白金信用卡按官方积分、银联 / 内地签账及 FTF 条款配置。
...
| 奖赏单位 | HKD |
| 计算器插件 | `beaUnionPayDualCurrencyPlatinum` |

## 概述

**东亚银行银联双币白金信用卡** 是 [[banks:bank-of-east-asia|东亚银行]](../banks/bank-of-east-asia.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 本地零售 2X | 额外 1 point / HK$1 = 0.4% |

## 计算器接入

| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `beaUnionPayDualCurrencyPlatinum` |
| 兑换计算器 | 否 | `—` |
