...
title: '中银双币卡'
shortName: '中银双币卡'
slug: bochk-dual-currency-gba-card
country: HK
bank: boc-hong-kong
...
rebateCalculator:
  enabled: true
  calculatorId: bochkDualCurrencyGbaCard
...
sources:
  - 'boc-hong-kong-official-terms-7'
...
> 中银双币卡 / BOC Dual Currency Card，覆盖大湾区一卡通相关双币使用场景。
...
| 奖赏单位 | HKD |
| 计算器插件 | `bochkDualCurrencyGbaCard` |

## 概述

**中银双币卡** 是 [[banks:boc-hong-kong|中银香港]](../banks/boc-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `bochkDualCurrencyGbaCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:boc-hong-kong-official-terms-7|中银香港 官方产品 / 条款]](../sources/boc-hong-kong-official-terms-7.md) — https://www.bochk.com/en/creditcard/details/boccreditcard/gba.html
...
[[Category:大湾区]]
[[Category:双币]]
[[Category:BOC Dual Currency Card]]
