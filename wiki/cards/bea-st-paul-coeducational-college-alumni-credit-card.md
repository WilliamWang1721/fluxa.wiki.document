---
collection: cards
title: '东亚银行圣保罗男女中学校友会信用卡'
shortName: '圣保罗校友'
slug: bea-st-paul-coeducational-college-alumni-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: beaStPaulCoeducationalCollegeAlumniCreditCard
...
> 东亚银行圣保罗男女中学校友会信用卡按基本奖赏与 FTF 规则收录。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 东亚银行圣保罗男女中学校友会信用卡 |
| 简称 | 圣保罗校友 |
| 市场 | 香港 |
...
| 奖赏单位 | HKD |
| 计算器插件 | `beaStPaulCoeducationalCollegeAlumniCreditCard` |

## 概述

**东亚银行圣保罗男女中学校友会信用卡** 是 [[banks:bank-of-east-asia|东亚银行]](../banks/bank-of-east-asia.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `beaStPaulCoeducationalCollegeAlumniCreditCard` |
| 兑换计算器 | 否 | `—` |
