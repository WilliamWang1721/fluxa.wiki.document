...
title: '美国运通白金信用卡'
shortName: '白金信用卡'
slug: american-express-platinum-credit-card-hk
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: amexPlatinumCreditCard
...
sources:
  - 'american-express-official-terms-30'
...
> 美国运通白金信用卡按官方 Membership Rewards 及 FTF 条款配置。
...
| 基本回赠 | 1 MR / HK$1 |
| 奖赏单位 | MR Points |
| 计算器插件 | `amexPlatinumCreditCard` |

## 概述

**美国运通白金信用卡** 是 [[banks:american-express|美国运通]](../banks/american-express.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `amexPlatinumCreditCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:american-express-official-terms-30|美国运通 官方产品 / 条款]](../sources/american-express-official-terms-30.md) — https://www.americanexpress.com/hk/en/campaigns/platinum-credit-card/index.html?path=rewards
