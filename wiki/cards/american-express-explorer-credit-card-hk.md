---
collection: cards
title: '美国运通 Explorer 信用卡'
shortName: 'Explorer'
slug: american-express-explorer-credit-card-hk
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: amexExplorerCreditCard
...
sources:
  - 'american-express-official-terms-31'
...
> 美国运通 Explorer 信用卡按 Membership Rewards 积分配置。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 美国运通 Explorer 信用卡 |
| 简称 | Explorer |
| 市场 | 香港 |
...
| 基本回赠 | 3 MR / HK$1 |
| 奖赏单位 | MR Points |
| 计算器插件 | `amexExplorerCreditCard` |

## 概述

**美国运通 Explorer 信用卡** 是 [[banks:american-express|美国运通]](../banks/american-express.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 项目 | 口径 |
| --- | --- |
| Membership Rewards 基本积分 | 3 MR / HK$1 |
| 网上签账额外 MR | 额外 2 MR / HK$1 |
| 外币 / 旅游额外 MR | 额外 7.75 MR / HK$1 |
| 迎新 MR | 144,000 MR |
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `amexExplorerCreditCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:american-express-official-terms-31|美国运通 官方产品 / 条款]](../sources/american-express-official-terms-31.md) — https://www.americanexpress.com/content/dam/amex/hk/benefits/pdf/FN_Explorer_MR_EN.pdf
