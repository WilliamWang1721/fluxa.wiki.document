...
title: '东亚银行公司卡'
shortName: '公司卡'
slug: bea-corporate-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: beaCorporateCreditCard
...
sources:
  - 'bank-of-east-asia-official-terms-10'
...
| 基本回赠 | 0.6% |
| 奖赏单位 | HKD |
| 计算器插件 | `beaCorporateCreditCard` |

## 概述

**东亚银行公司卡** 是 [[banks:bank-of-east-asia|东亚银行]](../banks/bank-of-east-asia.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `beaCorporateCreditCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:bank-of-east-asia-official-terms-10|东亚银行 官方产品 / 条款]](../sources/bank-of-east-asia-official-terms-10.md) — https://www.hkbea.com/html/en/bea-corporate-credit-card.html
