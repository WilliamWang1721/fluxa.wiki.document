---
collection: cards
title: '渣打 Simply Cash Visa 卡'
shortName: 'Simply Cash Visa'
slug: standard-chartered-simply-cash-visa-card
country: HK
...
sources:
  - 'standard-chartered-hong-kong-official-terms-13'
origin: payload-website-starter
generatedAt: 2026-08-21
---
{{Infobox card}}

# 渣打 Simply Cash Visa 卡

> 渣打 Simply Cash Visa 卡按现金回赠、基本奖赏与 FTF 规则收录。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 渣打 Simply Cash Visa 卡 |
| 简称 | Simply Cash Visa |
| 市场 | 香港 |
...
| 基本回赠 | 1.5% |
| 奖赏单位 | HKD |
| 计算器插件 | `scSimplyCashVisa` |

## 概述

**渣打 Simply Cash Visa 卡** 是 [[banks:standard-chartered-hong-kong|渣打香港]](../banks/standard-chartered-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
- [[sources:standard-chartered-hong-kong-official-terms-13|渣打香港 官方产品 / 条款]](../sources/standard-chartered-hong-kong-official-terms-13.md) — https://www.sc.com/hk/credit-cards/simplycash/
