---
collection: cards
title: '渣打 A.Point Card'
shortName: 'A.Point'
slug: standard-chartered-a-point-card
country: HK
...
sources:
  - 'standard-chartered-hong-kong-official-terms-14'
...
> 渣打 A.Point Card 按 A.Point / AlipayHK、跨境及网上消费奖赏口径配置。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 渣打 A.Point Card |
| 简称 | A.Point |
| 市场 | 香港 |
...
**渣打 A.Point Card** 是 [[banks:standard-chartered-hong-kong|渣打香港]](../banks/standard-chartered-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 项目 | 口径 |
| --- | --- |
| AlipayHK 合资格签账 | 2 A.Point / HK$1 |
| AlipayHK 跨境 20X | 额外 18 A.Point / HK$1 |
| 实体卡 / 手机钱包 10X | 10 A.Point / HK$1 |

## 计算器接入

| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `scAPointCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:standard-chartered-hong-kong-official-terms-14|渣打香港 官方产品 / 条款]](../sources/standard-chartered-hong-kong-official-terms-14.md) — https://www.sc.com/hk/credit-cards/apointcard/
