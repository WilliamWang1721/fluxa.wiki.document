...
title: '美国运通国泰尊尚信用卡'
shortName: '国泰尊尚'
slug: american-express-cathay-pacific-elite-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: amexCathayPacificEliteCreditCard
...
sources:
  - 'american-express-official-terms-32'
...
> 美国运通国泰尊尚信用卡按 Asia Miles / 国泰签账口径配置。
...
| 银联双币 | 否 |
| 基本回赠 | 1 Asia Mile / HK$4 |
| 奖赏单位 | Asia Miles |
| 计算器插件 | `amexCathayPacificEliteCreditCard` |

## 概述

**美国运通国泰尊尚信用卡** 是 [[banks:american-express|美国运通]](../banks/american-express.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 项目 | 口径 |
| --- | --- |
| Asia Miles 基本里数 | 1 Asia Mile / HK$4 |

## 计算器接入

| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `amexCathayPacificEliteCreditCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:american-express-official-terms-32|美国运通 官方产品 / 条款]](../sources/american-express-official-terms-32.md) — https://www.americanexpress.com/content/dam/amex/hk/en/staticassets/pdf/BDT_CX_KNOWMORE_EN_A0000EWAJY.pdf
