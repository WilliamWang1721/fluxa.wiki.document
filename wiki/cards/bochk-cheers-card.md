---
collection: cards
title: '中银香港 Cheers Card'
shortName: 'Cheers Card'
slug: bochk-cheers-card
country: HK
bank: boc-hong-kong
...
> 中银香港 Cheers Card 按餐饮 / 生活类别、基本奖赏与 FTF 规则收录。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 中银香港 Cheers Card |
| 简称 | Cheers Card |
| 市场 | 香港 |
...
| 奖赏单位 | HKD |
| 计算器插件 | `bochkCheersCard` |

## 概述

**中银香港 Cheers Card** 是 [[banks:boc-hong-kong|中银香港]](../banks/boc-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
