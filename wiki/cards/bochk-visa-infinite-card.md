---
collection: cards
title: '中银香港 Visa Infinite 卡（旧称）'
shortName: 'Visa Infinite'
slug: bochk-visa-infinite-card
country: HK
bank: boc-hong-kong
...
rebateCalculator:
  enabled: true
  calculatorId: bochkVisaInfiniteCard
...
sources:
  - 'boc-hong-kong-official-terms-3'
origin: payload-website-starter
generatedAt: 2026-08-21
---
{{Infobox card}}

# 中银香港 Visa Infinite 卡（旧称）

> 中银香港 Visa Infinite 卡已于 2023-08-01 更名为 BOC Cheers Card；保留为旧名称索引。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 中银香港 Visa Infinite 卡（旧称） |
| 简称 | Visa Infinite |
| 市场 | 香港 |
...
| 奖赏单位 | HKD |
| 计算器插件 | `bochkVisaInfiniteCard` |

## 概述

**中银香港 Visa Infinite 卡（旧称）** 是 [[banks:boc-hong-kong|中银香港]](../banks/boc-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| Cheers 本地餐饮 10X | 额外 9 points / HK$1 = 3.6% |
| Cheers 旅游 10X | 额外 9 points / HK$1 = 3.6% |

## 计算器接入

| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `bochkVisaInfiniteCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:boc-hong-kong-official-terms-3|中银香港 官方产品 / 条款]](../sources/boc-hong-kong-official-terms-3.md) — https://www.bochk.com/dam/boccreditcard/cheerscard/eng/index.html?scode=360
