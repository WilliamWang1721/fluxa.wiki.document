---
collection: cards
title: '渣打 Visa Infinite 信用卡'
shortName: 'Visa Infinite'
slug: standard-chartered-visa-infinite-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: scVisaInfiniteCreditCard
...
sources:
  - 'standard-chartered-hong-kong-official-terms-15'
origin: payload-website-starter
generatedAt: 2026-08-21
---
{{Infobox card}}

# 渣打 Visa Infinite 信用卡

> 渣打 Visa Infinite 信用卡按官方 360 Rewards、本地 / 海外签账及 FTF 条款配置。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 渣打 Visa Infinite 信用卡 |
| 简称 | Visa Infinite |
| 市场 | 香港 |
...
| 计算器插件 | `scVisaInfiniteCreditCard` |

## 概述

**渣打 Visa Infinite 信用卡** 是 [[banks:standard-chartered-hong-kong|渣打香港]](../banks/standard-chartered-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 项目 | 口径 |
| --- | --- |
| 本地签账 2X | 2 points / HK$1 |
| 海外签账 3X | 3 points / HK$1 |

## 计算器接入

| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `scVisaInfiniteCreditCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:standard-chartered-hong-kong-official-terms-15|渣打香港 官方产品 / 条款]](../sources/standard-chartered-hong-kong-official-terms-15.md) — https://www.sc.com/hk/credit-cards/visa-infinite/
