...
title: '美国运通绿卡'
shortName: '绿卡'
slug: american-express-green-credit-card-hk
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: amexGreenCreditCard
...
| 基本回赠 | 1 MR / HK$1 |
| 奖赏单位 | MR Points |
| 计算器插件 | `amexGreenCreditCard` |

## 概述

**美国运通绿卡** 是 [[banks:american-express|美国运通]](../banks/american-express.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
