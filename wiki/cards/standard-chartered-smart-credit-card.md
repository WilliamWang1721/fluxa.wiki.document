...
title: '渣打 Smart 信用卡'
shortName: 'Smart'
slug: standard-chartered-smart-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: scSmartCreditCard
...
sources:
  - 'standard-chartered-hong-kong-official-terms-12'
...
> 渣打 Smart 信用卡按生活类别、基本奖赏与 FTF 规则收录。
...
| 基本回赠 | 0.56% |
| 奖赏单位 | HKD |
| 计算器插件 | `scSmartCreditCard` |

## 概述

**渣打 Smart 信用卡** 是 [[banks:standard-chartered-hong-kong|渣打香港]](../banks/standard-chartered-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 项目 | 口径 |
| --- | --- |
| 其他合资格签账基础 CashBack | 0.56% |
| 其他签账额外 CashBack | 额外 0.64% |
| 指定商户额外 CashBack | 额外 4.44% |

## 计算器接入

| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `scSmartCreditCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:standard-chartered-hong-kong-official-terms-12|渣打香港 官方产品 / 条款]](../sources/standard-chartered-hong-kong-official-terms-12.md) — https://www.sc.com/hk/credit-cards/smart/
