...
title: '渣打白金信用卡'
shortName: '白金'
slug: standard-chartered-platinum-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: scPlatinumCreditCard
...
| 计算器插件 | `scPlatinumCreditCard` |

## 概述

**渣打白金信用卡** 是 [[banks:standard-chartered-hong-kong|渣打香港]](../banks/standard-chartered-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
