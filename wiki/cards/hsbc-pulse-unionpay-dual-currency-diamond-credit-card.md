...
> 内地/澳门 QR/AP、内地餐饮、赏世界、Travel Guru 与迎新活动组合计算。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 汇丰 Pulse 银联双币钻石信用卡 |
| 简称 | Pulse 银联钻石 |
| 市场 | 香港 |
...
| 银联双币 | 是 |
| 计算器插件 | `hsbcPulseUnionPayDiamond` |
| 兑换规则 | `unionPayDualCurrency` |

## 概述

**汇丰 Pulse 银联双币钻石信用卡** 是 [[banks:hsbc-hong-kong|汇丰香港]](../banks/hsbc-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `hsbcPulseUnionPayDiamond` |
