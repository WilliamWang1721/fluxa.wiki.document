---
collection: cards
title: 'HSBC Expat Premier World Elite Mastercard 信用卡'
shortName: 'Premier World Elite'
slug: hsbc-expat-premier-world-elite-mastercard
country: EXPAT_JE
bank: hsbc-expat
...
rebateCalculator:
  enabled: true
  calculatorId: globalHsbcExpatPremierWorldEliteMastercard
...
tags:
  ...
  - 'EXPAT_JE'
  - 'Premier World Elite'
  - '可申请，需 Expat / Premier 资格，通常联系 RM'
relatedCards:
  - 'hsbc-expat-premier-mastercard'
...
# HSBC Expat Premier World Elite Mastercard 信用卡

> HSBC Expat / 泽西离岸 HSBC 官方信用卡产品。官方名称：Premier World Elite Mastercard。状态：可申请，需 Expat / Premier 资格，通常联系 RM。

| 字段 | 值 |
| --- | --- |
| 官方名称 | HSBC Expat Premier World Elite Mastercard 信用卡 |
...
| 银联双币 | 否 |
| 计算器插件 | `globalHsbcExpatPremierWorldEliteMastercard` |
| 英文官方名 | Premier World Elite Mastercard |
| 产品状态 | 可申请，需 Expat / Premier 资格，通常联系 RM |

## 概述

**HSBC Expat Premier World Elite Mastercard 信用卡** 是 [[banks:hsbc-expat|汇丰 Expat]](../banks/hsbc-expat.md) 在HSBC Expat / 泽西离岸市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `globalHsbcExpatPremierWorldEliteMastercard` |
| 兑换计算器 | 否 | `—` |
...
[[Category:可申请，需 Expat / Premier 资格，通常联系 RM]]
