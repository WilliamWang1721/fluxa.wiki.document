...
title: '渣打行政人员信用卡'
shortName: '行政人员'
slug: standard-chartered-executive-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: scExecutiveCreditCard
...
sources:
  - 'standard-chartered-hong-kong-official-terms-17'
...
| 基本回赠 | 0.5% |
| 奖赏单位 | HKD |
| 计算器插件 | `scExecutiveCreditCard` |

## 概述

**渣打行政人员信用卡** 是 [[banks:standard-chartered-hong-kong|渣打香港]](../banks/standard-chartered-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
- [[sources:standard-chartered-hong-kong-official-terms-17|渣打香港 官方产品 / 条款]](../sources/standard-chartered-hong-kong-official-terms-17.md) — https://www.sc.com/hk/credit-cards/executive-platinum/
