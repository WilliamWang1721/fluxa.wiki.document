...
sources:
  - 'bank-of-east-asia-official-terms'
...
> 东亚银行 AIA 信用卡按保险 / 基本奖赏与 FTF 规则收录。
...
| 奖赏单位 | HKD |
| 计算器插件 | `beaAiaCreditCard` |

## 概述

**东亚银行 AIA 信用卡** 是 [[banks:bank-of-east-asia|东亚银行]](../banks/bank-of-east-asia.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| AIA 健康生活类别 3X | 额外 2 points / HK$1 = 0.8% |

## 计算器接入

| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `beaAiaCreditCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:bank-of-east-asia-official-terms|东亚银行 官方产品 / 条款]](../sources/bank-of-east-asia-official-terms.md) — https://www.hkbea.com/pdf/en/credit-card/BEAAIA/BEAAIACreditCardFeature_en.pdf
