---
collection: cards
title: '汇丰越南 Cash Back 信用卡'
shortName: 'Cash Back'
slug: hsbc-vn-cash-back-credit-card
country: VN
bank: hsbc-vietnam
...
rebateCalculator:
  enabled: true
  calculatorId: globalHsbcVnCashBackCreditCard
  issuer: 'HSBC VN'
...
> 越南 HSBC 官方信用卡产品。官方名称：HSBC Cash Back Credit Card。状态：官方产品页列出，未见停售标记。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 汇丰越南 Cash Back 信用卡 |
| 简称 | Cash Back |
| 市场 | 越南 |
...
| 银联双币 | 否 |
| 计算器插件 | `globalHsbcVnCashBackCreditCard` |
| 英文官方名 | HSBC Cash Back Credit Card |
| 产品状态 | 官方产品页列出，未见停售标记 |

## 概述

**汇丰越南 Cash Back 信用卡** 是 [[banks:hsbc-vietnam|汇丰越南]](../banks/hsbc-vietnam.md) 在越南市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `globalHsbcVnCashBackCreditCard` |
| 兑换计算器 | 否 | `—` |
