---
collection: cards
title: '中银 i-card 双币钻石虚拟卡'
shortName: 'i-card 双币钻石虚拟卡'
slug: bochk-i-card-virtual-card
country: HK
bank: boc-hong-kong
...
rebateCalculator:
  enabled: true
  calculatorId: bochkICardVirtual
...
sources:
  - 'boc-hong-kong-official-terms-6'
...
> 中银 i-card 双币钻石虚拟卡，对应 BOC i-card Dual Currency Diamond Card 的虚拟卡版本。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 中银 i-card 双币钻石虚拟卡 |
| 简称 | i-card 双币钻石虚拟卡 |
| 市场 | 香港 |
...
| 银联双币 | 否 |
| 基本回赠 | 1 point / HK$1/RMB1 = 0.4% |
| 奖赏单位 | HKD |
| 计算器插件 | `bochkICardVirtual` |

## 概述

**中银 i-card 双币钻石虚拟卡** 是 [[banks:boc-hong-kong|中银香港]](../banks/boc-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 项目 | 口径 |
| --- | --- |
| Gift Point 基本现金价值 | 1 point / HK$1/RMB1 = 0.4% |

## 计算器接入

| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `bochkICardVirtual` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:boc-hong-kong-official-terms-6|中银香港 官方产品 / 条款]](../sources/boc-hong-kong-official-terms-6.md) — https://www.bochk.com/creditcard/pdf/eng/icardDC_WG_notes_eng.pdf
