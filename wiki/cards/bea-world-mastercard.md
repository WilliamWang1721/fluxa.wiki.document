---
collection: cards
title: '东亚银行 World Mastercard 卡'
shortName: 'World Mastercard'
slug: bea-world-mastercard
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: beaWorldMastercard
...
# 东亚银行 World Mastercard 卡

> 东亚银行 World Mastercard 按官方 BEA Mileage、海外签账及 FTF 条款配置。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 东亚银行 World Mastercard 卡 |
| 简称 | World Mastercard |
| 市场 | 香港 |
...
| 基本回赠 | 1 mile / HK$10 |
| 奖赏单位 | Asia Miles |
| 计算器插件 | `beaWorldMastercard` |

## 概述

**东亚银行 World Mastercard 卡** 是 [[banks:bank-of-east-asia|东亚银行]](../banks/bank-of-east-asia.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
