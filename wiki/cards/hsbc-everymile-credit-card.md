...
> 基础 RewardCash、EveryMile 兑换价值口径与 FTF 计算。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 汇丰 EveryMile 信用卡 |
| 简称 | EveryMile |
| 市场 | 香港 |
...
**汇丰 EveryMile 信用卡** 是 [[banks:hsbc-hong-kong|汇丰香港]](../banks/hsbc-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
