---
collection: cards
title: '中银香港 Private Card'
shortName: 'Private Card'
slug: bochk-private-card
country: HK
bank: boc-hong-kong
...
> 中银香港 Private Card 按基本奖赏、指定类别奖赏和 FTF 官方条款收录。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 中银香港 Private Card |
| 简称 | Private Card |
| 市场 | 香港 |
...
| 奖赏单位 | HKD |
| 计算器插件 | `bochkPrivateCard` |

## 概述

**中银香港 Private Card** 是 [[banks:boc-hong-kong|中银香港]](../banks/boc-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
- [[sources:boc-hong-kong-official-terms|中银香港 官方产品 / 条款]](../sources/boc-hong-kong-official-terms.md) — https://www.bochk.com/en/creditcard/details/boccreditcard/privatecard.html
