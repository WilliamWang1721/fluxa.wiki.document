---
collection: cards
title: '汇丰卡塔尔 Premier 信用卡'
shortName: 'Premier'
slug: hsbc-qa-premier-credit-card
country: QA
bank: hsbc-qatar
...
rebateCalculator:
  enabled: true
  calculatorId: globalHsbcQaPremierCreditCard
  issuer: 'HSBC QA'
...
> 卡塔尔 HSBC 官方信用卡产品。官方名称：HSBC Premier Credit Card。状态：Premier 客户产品。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 汇丰卡塔尔 Premier 信用卡 |
| 简称 | Premier |
| 市场 | 卡塔尔 |
...
| 银联双币 | 否 |
| 计算器插件 | `globalHsbcQaPremierCreditCard` |
| 英文官方名 | HSBC Premier Credit Card |
| 产品状态 | Premier 客户产品 |

## 概述

**汇丰卡塔尔 Premier 信用卡** 是 [[banks:hsbc-qatar|汇丰卡塔尔]](../banks/hsbc-qatar.md) 在卡塔尔市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `globalHsbcQaPremierCreditCard` |
| 兑换计算器 | 否 | `—` |
