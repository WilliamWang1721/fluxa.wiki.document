...
title: '汇丰生活信用卡'
shortName: '生活信用卡'
slug: hsbc-cn-choice-credit-card
country: CN
bank: hsbc-china
...
rebateCalculator:
  enabled: true
  calculatorId: globalHsbcCnChoiceCreditCard
  issuer: 'HSBC CN'
...
> 中国内地 HSBC 官方信用卡产品。官方名称：HSBC Choice Credit Card。状态：仅限符合条件持卡人到期续卡使用。
...
| 银联双币 | 否 |
| 计算器插件 | `globalHsbcCnChoiceCreditCard` |
| 英文官方名 | HSBC Choice Credit Card |
| 产品状态 | 仅限符合条件持卡人到期续卡使用 |

## 概述

**汇丰生活信用卡** 是 [[banks:hsbc-china|汇丰中国]](../banks/hsbc-china.md) 在中国内地市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `globalHsbcCnChoiceCreditCard` |
| 兑换计算器 | 否 | `—` |
