---
collection: cards
title: '美国运通 Blue Cash 信用卡'
shortName: 'Blue Cash'
slug: american-express-blue-cash-credit-card-hk
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: amexBlueCashCreditCard
...
sources:
  - 'american-express-official-terms-33'
...
> 美国运通 Blue Cash 信用卡按现金回赠口径配置。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 美国运通 Blue Cash 信用卡 |
| 简称 | Blue Cash |
| 市场 | 香港 |
...
| 基本回赠 | 1.2% |
| 奖赏单位 | HKD |
| 计算器插件 | `amexBlueCashCreditCard` |

## 概述

**美国运通 Blue Cash 信用卡** 是 [[banks:american-express|美国运通]](../banks/american-express.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `amexBlueCashCreditCard` |
| 兑换计算器 | 否 | `—` |
...
- [[sources:american-express-official-terms-33|美国运通 官方产品 / 条款]](../sources/american-express-official-terms-33.md) — https://www.americanexpress.com/hk/en/credit-cards/blue-cash-credit-card/
