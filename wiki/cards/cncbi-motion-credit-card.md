---
collection: cards
title: '信银香港 Motion 信用卡'
shortName: 'Motion'
slug: cncbi-motion-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: cncbiMotionCreditCard
...
sources:
  - 'citic-international-official-terms-27'
...
> 信银香港 Motion 信用卡按网上 / 生活类别、基本奖赏与 FTF 规则收录。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 信银香港 Motion 信用卡 |
| 简称 | Motion |
| 市场 | 香港 |
...
| 基本回赠 | 0.4% |
| 奖赏单位 | HKD |
| 计算器插件 | `cncbiMotionCreditCard` |

## 概述

**信银香港 Motion 信用卡** 是 [[banks:citic-international|中信银行国际]](../banks/citic-international.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
- [[sources:citic-international-official-terms-27|中信银行国际 官方产品 / 条款]](../sources/citic-international-official-terms-27.md) — https://www.cncbinternational.com/_document/personal/motion_credit_card/en/motion_cardcvp_tnc_en.pdf?uuid=GOI3NoXfVGYREGct0957
