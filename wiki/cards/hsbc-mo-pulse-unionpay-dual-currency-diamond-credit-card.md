---
collection: cards
title: '汇丰澳门 Pulse 银联双币钻石信用卡'
shortName: 'Pulse 银联钻石'
slug: hsbc-mo-pulse-unionpay-dual-currency-diamond-credit-card
country: MO
bank: hsbc-macau
...
rebateCalculator:
  enabled: true
  calculatorId: globalHsbcMoPulseUnionpayDualCurrencyDiamondCreditCard
  issuer: 'HSBC MO'
...
# 汇丰澳门 Pulse 银联双币钻石信用卡

> 澳门 HSBC 官方信用卡产品。官方名称：HSBC Pulse UnionPay Dual Currency Diamond Credit Card。状态：官方产品页列出，未见停售标记。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 汇丰澳门 Pulse 银联双币钻石信用卡 |
| 简称 | Pulse 银联钻石 |
| 市场 | 澳门 |
...
| 银联双币 | 是 |
| 计算器插件 | `globalHsbcMoPulseUnionpayDualCurrencyDiamondCreditCard` |
| 英文官方名 | HSBC Pulse UnionPay Dual Currency Diamond Credit Card |
| 产品状态 | 官方产品页列出，未见停售标记 |

## 概述

**汇丰澳门 Pulse 银联双币钻石信用卡** 是 [[banks:hsbc-macau|汇丰澳门]](../banks/hsbc-macau.md) 在澳门市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `globalHsbcMoPulseUnionpayDualCurrencyDiamondCreditCard` |
| 兑换计算器 | 否 | `—` |
