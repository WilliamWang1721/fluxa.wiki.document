...
title: '渣打银联双币白金信用卡'
shortName: '银联双币白金'
slug: standard-chartered-unionpay-dual-currency-platinum-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: scUnionPayDualCurrencyPlatinum
...
> 渣打银联双币白金信用卡按银联 / 内地签账和 FTF 官方条款收录。
...
| 计算器插件 | `scUnionPayDualCurrencyPlatinum` |

## 概述

**渣打银联双币白金信用卡** 是 [[banks:standard-chartered-hong-kong|渣打香港]](../banks/standard-chartered-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `scUnionPayDualCurrencyPlatinum` |
| 兑换计算器 | 否 | `—` |
