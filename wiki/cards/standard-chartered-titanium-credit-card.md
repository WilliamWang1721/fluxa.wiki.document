---
collection: cards
title: '渣打 Titanium 信用卡'
shortName: 'Titanium'
slug: standard-chartered-titanium-credit-card
country: HK
...
rebateCalculator:
  enabled: true
  calculatorId: scTitaniumCreditCard
...
> 渣打 Titanium 信用卡按餐饮 / 基本奖赏与 FTF 规则收录。

| 字段 | 值 |
| --- | --- |
| 官方名称 | 渣打 Titanium 信用卡 |
| 简称 | Titanium |
| 市场 | 香港 |
...
| 计算器插件 | `scTitaniumCreditCard` |

## 概述

**渣打 Titanium 信用卡** 是 [[banks:standard-chartered-hong-kong|渣打香港]](../banks/standard-chartered-hong-kong.md) 在香港市场发行的信用卡词条。本页是 Fluxa WikiCard 的 Git 暂存稿：主站 [fluxa.wiki](https://fluxa.wiki) 的正文目前写在 Payload 数据库里，等 `payload-website-starter` 代码稳定后再迁回 Cards collection。
...
| 项目 | 口径 |
| --- | --- |
| 基本积分 1X | 1 point / HK$1 |
| 每月 8 日额外积分 | 额外 7 points / HK$1 |

## 计算器接入

| 类型 | 是否接入 | 标识 |
| --- | --- | --- |
| 返利计算器 | 是 | `scTitaniumCreditCard` |
| 兑换计算器 | 否 | `—` |
